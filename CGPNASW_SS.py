...
from CGPNASWSS.CartesianCellSamplingWX import CartesianCellGeneticProgrammingWX
from CGPNASWSS.CrossoverCellCgpWX import CrossoverCellCgpWX
from CGPNASWSS.NnevaluationWX import NNevalWX
from CGPNASWSS.MutationCellCgpWX import MutationCellCgpWX
...
if __name__ == '__main__':
    ...
    algorithm = NSGA2(
        ...
        sampling=CartesianCellGeneticProgrammingWX(CONF_LAYERS, model_pool, N=normal_blocks, R=normal_blocks - 1),
        crossover=CrossoverCellCgpWX(eta=20, prob=0.9),
        mutation=MutationCellCgpWX(prob=0.3, eta=15),
        eliminate_duplicates=False
    )

    # Dataset configuration for evaluation
    dataset_name = 'CIFAR-100P'
    evaluation_problem = NNevalWX(
        nvar_real=n_var,
        epochNum=epochs,
